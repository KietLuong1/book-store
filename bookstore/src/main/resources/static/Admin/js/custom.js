...
(function (jQuery) {
    ...
    jQuery(document).ready(function () {
        ...
        const breadcrumbList = document.getElementById("bcr");

        const navigationLinks = document.querySelectorAll("#iq-sidebar-toggle a");
        ...
        navigationLinks.forEach(link => {
            ...
            if (currentUrl.startsWith(linkUrl)) {
                ...
                if (linkUrl === currentUrl) {
                    breadcrumbItem.textContent = link.textContent;
                } else {
                    const breadcrumbLink = document.createElement("a");
                    breadcrumbLink.setAttribute("href", linkUrl);
                    breadcrumbLink.textContent = link.textContent;
